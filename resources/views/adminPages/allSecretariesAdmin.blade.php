    						...
    						<div class="table-responsive">
                                <table class="table table-striped custom-table">
                                    ...
                                    <tbody>
                                        <tr>
                                            <td>
    											<img width="28" height="28" src="{{ asset('scrtrDoctorPage/img/user.jpg')}}" class="rounded-circle" alt=""> <h2>Albina Simonis</h2>
    										</td>
                                            <td>NS-0001</td>
                                        ...
                                        <tr>
                                            <td>
    											<img width="28" height="28" src="{{ asset('scrtrDoctorPage/img/user.jpg')}}" class="rounded-circle" alt=""> <h2>Cristina Groves</h2>
    										</td>
                                            <td>DR-0001</td>
    									...
    									<tr>
                                            <td>
    											<img width="28" height="28" src="{{ asset('scrtrDoctorPage/img/user.jpg')}}" class="rounded-circle" alt=""> <h2>Mary Mericle</h2>
    										</td>
                                            <td>SF-0003</td>
    									...
    									<tr>
                                            <td>
    											<img width="28" height="28" src="{{ asset('scrtrDoctorPage/img/user.jpg')}}" class="rounded-circle" alt=""> <h2>Haylie Feeney</h2>
    										</td>
                                            <td>SF-0002</td>
    									...
    									<tr>
                                            <td>
    											<img width="28" height="28" src="{{ asset('scrtrDoctorPage/img/user.jpg')}}" class="rounded-circle" alt=""> <h2>Zoe Butler</h2>
    										</td>
                                            <td>SF-0001</td>
