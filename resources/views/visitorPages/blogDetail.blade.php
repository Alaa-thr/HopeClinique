...
<!-- Blog Details Section Begin -->
    <section class="blog-details spad">
        <div class="container">
            <div class="blog__details__hero set-bg" data-setbg="{{ asset('visitorPage/img/blog/details/blog-hero.jpg')}}">
            ...
            <div class="row d-flex justify-content-center">
                ...
                <div class="col-lg-12">
                    <div class="blog__details__pic">
                        <div class="row">
                            <div class="col-sm-4">
                                <img src="{{ asset('visitorPage/img/blog/details/bd-1.jpg')}}" alt="">
                            </div>
                            <div class="col-sm-4">
                                <img src="{{ asset('visitorPage/img/blog/details/bd-2.jpg')}}" alt="">
                            </div>
                            <div class="col-sm-4">
                                <img src="{{ asset('visitorPage/img/blog/details/bd-3.jpg')}}" alt="">
                            </div>
                        </div>
                    </div>
                </div>
                        ...
                        <div class="row">
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <a href="#" class="blog__details__btn__item">
                                    ...
                                    <div class="blog__details__btn__pic">
                                        <img src="{{ asset('visitorPage/img/blog/details/prev.jpg')}}" alt="">
                                    </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6">
                                <a href="#" class="blog__details__btn__item blog__details__btn__prev">
                                    ...
                                    <div class="blog__details__btn__pic">
                                        <img src="{{ asset('visitorPage/img/blog/details/next.jpg')}}" alt="">
                                    </div>
                                    <div class="blog__details__btn__text">
                                        <h6>Looking for Music & Sounds for my new Android...</h6>
                                        <span>Nov 27, 2019</span>
